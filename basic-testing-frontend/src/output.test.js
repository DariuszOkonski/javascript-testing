...
describe('generateResultText(calculationResult)', () => {
    ...
    it('should return a string that contains the calculation result if a number is proovided as a result', () => {
        const result = 5;
    ...
    it('should return an emty string if "no-calc" is provided as a result', () => {
